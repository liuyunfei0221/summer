...
public class BlueLifecycleBeanDefinitionRegistrar implements ResourceLoaderAware, ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(@NonNull AnnotationMetadata importingClassMetadata, @NonNull BeanDefinitionRegistry registry) {
        ...
        LOGGER.info("BlueLifecycleBeanDefinitionRegistrar.void registerBeanDefinitions(@NonNull AnnotationMetadata importingClassMetadata, @NonNull BeanDefinitionRegistry registry), basePackages = {}",
