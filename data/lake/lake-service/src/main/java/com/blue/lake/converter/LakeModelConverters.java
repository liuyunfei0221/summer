...
public final class LakeModelConverters {
    ...
    public static final Function<DataEvent, OptEvent> DATA_EVENT_2_OPT_EVENT = param -> {
        ...
        optEvent.setRealUri(ofNullable(entries.get(BlueDataAttrKey.REAL_URI.key)).orElse(""));
        ...
        optEvent.setResponseBody(ofNullable(entries.get(RESPONSE_BODY.key)).orElse(""));
