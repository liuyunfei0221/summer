...
public final class OrderSummaryInsertProducer implements BlueLifecycle {
    ...
    public OrderSummaryInsertProducer(PulsarClient pulsarClient, ExecutorService executorService, BlueProducerConfig blueProducerConfig) {
        this.executorService = executorService;
        this.pulsarProducer = generateProducer(pulsarClient, blueProducerConfig.getByKey(ORDER_SUMMARY_INSERT.name), OrderSummary.class);
    }
