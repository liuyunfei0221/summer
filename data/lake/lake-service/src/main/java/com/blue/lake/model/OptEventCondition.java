...
public final class OptEventCondition extends SortCondition implements Serializable {
    ...
    public OptEventCondition(String dataEventType, String dataEventOpType, Long stampBegin, Long stampEnd, String method, String uri, String realUri, Integer responseStatus, Long memberId,
                             Long roleId, String credentialType, String deviceType, Long loginTimeBegin, Long loginTimeEnd, String clientIp, String userAgent,
                             Integer durationSecondsMin, Integer durationSecondsMax, String sortAttribute, String sortType) {
        super(sortAttribute, sortType);
