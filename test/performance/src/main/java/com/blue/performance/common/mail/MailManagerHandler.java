package com.blue.performance.common.mail;//import com.blue.basic.common.base.FileProcessor;
...
//
//        mailSenderTemp.signWithDomainKey(builder);
//
//        CompletableFuture<Void> future = mailSenderTemp.sendMail(builder.buildEmail())
