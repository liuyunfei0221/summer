...
public final class ShineUpdateProducer implements BlueLifecycle {
    ...
    public ShineUpdateProducer(ExecutorService executorService, BlueProducerConfig blueProducerConfig) {
        this.executorService = executorService;
        this.pulsarProducer = generateProducer(blueProducerConfig.getByKey(SHINE_UPDATE.name), Shine.class);
    }
