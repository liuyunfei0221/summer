...
public final class IllegalMarkConsumer implements BlueLifecycle {
    ...
    private void init() {
        ...
        ConsumerConfParams illegalMarkEventDeploy = blueConsumerConfig.getByKey(ILLEGAL_MARK.name);
        this.illegalMarkEventConsumer = generateConsumer(illegalMarkEventDeploy, illegalMarkEventDataConsumer);
    }
