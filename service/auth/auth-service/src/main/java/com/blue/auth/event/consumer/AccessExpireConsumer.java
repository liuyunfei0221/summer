...
import static com.blue.base.constant.common.BlueTopic.ACCESS_EXPIRE;
...
public final class AccessExpireConsumer implements BlueLifecycle {
    ...
    private BluePulsarConsumer<KeyExpireEvent> authExpireConsumer;
    ...
    @PostConstruct
    private void init() {
        Consumer<KeyExpireEvent> authExpireDataConsumer = keyExpireEvent ->
                ofNullable(keyExpireEvent)
                        .ifPresent(kep -> {
