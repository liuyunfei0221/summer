...
public final class AgreementInsertParam implements Serializable, Asserter {
    ...
    public AgreementInsertParam(String title, String content, String link, Integer type) {
        this.title = title;
