...
public class RpcControlServiceProvider implements RpcControlService {
    ...
    public RpcControlServiceProvider(ControlService controlService, AuthService authService, Scheduler scheduler) {
    ...
    public CompletableFuture<AuthorityBaseOnRole> getAuthorityByAccess(Access access) {
        ...
        return just(access).publishOn(scheduler).flatMap(authService::getAuthorityMonoByAccess).toFuture();
    }
    ...
    public CompletableFuture<AuthorityBaseOnRole> getAuthorityByMemberId(Long memberId) {
        ...
        return just(memberId).publishOn(scheduler).flatMap(authService::getAuthorityMonoByMemberId).toFuture();
    }
