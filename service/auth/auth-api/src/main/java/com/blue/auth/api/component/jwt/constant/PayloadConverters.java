...
public final class PayloadConverters {
     ...
     */
    public static final Function<MemberPayload, Map<String, String>> PAYLOAD_2_CLAIM_CONVERTER = p -> {
     ...
     */
    public static final Function<Map<String, String>, MemberPayload> CLAIM_2_PAYLOAD_CONVERTER = c ->
