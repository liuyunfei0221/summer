...
-- base manage
       ...
       (110017, 'GET', 'blue-base', '/manager/languages', b'1', b'1', b'1', b'0', b'1', 2,
       ...
       (110019, 'POST', 'blue-base', '/manager/styles', b'1', b'1', b'1', b'1', b'1', 2,
        'style list of manager', 'style list of manager', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 1, 1),
       (110020, 'POST', 'blue-base', '/manager/style', b'1', b'1', b'1', b'1', b'1', 2,
        'insert style', 'insert style', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 1, 1),
       (110021, 'PUT', 'blue-base', '/manager/style', b'1', b'1', b'1', b'1', b'1', 2,
        'update style', 'update style', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 1, 1),
       (110022, 'DELETE', 'blue-base', '/manager/style/{id}', b'1', b'1', b'1', b'1', b'1', 2,
        'delete style', 'delete style', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 1, 1),
       (110023, 'PUT', 'blue-base', '/manager/style/active', b'1', b'1', b'1', b'1', b'1', 2,
...
-- event api
       ...
       (300001, 'POST', 'blue-event', '/event', b'0', b'1', b'1', b'1', b'1', 1,
