package com.blue.risk.config.mq.producer;
...
public final class IllegalMarkProducer implements BlueLifecycle {
    ...
    public IllegalMarkProducer(ExecutorService executorService, BlueProducerConfig blueProducerConfig) {
        ...
        this.illegalMarkProducer = generateProducer(blueProducerConfig.getByKey(BlueTopic.ILLEGAL_MARK.name), IllegalMarkEvent.class);
    }
